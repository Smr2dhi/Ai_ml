...
from Assign4.hard_1.services.student_service import StudentService
from Assign4.hard_1.utils.storage import save_students,load_students
...
def main():
    ...
    while True:
        ...
        if choice==1:
            ...
            session_logger.debug(f"Adding student: {name}")
            ...
            if result:
                ...
                global_logger.warning(f"Rollno {rollno} already exists")
            ...
            session_logger.debug(f"Searching student: {search_name}")
            ...
            session_logger.info("Application exited")
            break

        else:
            global_logger.warning(f"Invalid menu option: {choice}")
